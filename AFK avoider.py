...
class Window:
    def __init__(self):
        ...
        self.yes_button = tk.Button(self.button_frame, text="Yes", font=("Times New Roman", 15), width=5, command=self.yes)
        self.yes_button.grid(row=0, column=0, ipadx=10)
        self.no_button = tk.Button(self.button_frame, text="No", font=("Times New Roman", 15), width=5, command=self.no)
